  ...
  "node_modules/@mediapipe/selfie_segmentation/selfie_segmentation.js"(exports) {
    (function() {
      ...
      function sa(a2, b) {
        ...
        var c2 = a2.h.j;
        if (c2)
          return ta(a2, "return" in c2 ? c2["return"] : function(d2) {
      ...
      function ua(a2) {
        for (; a2.h.h; )
          try {
            var b = a2.i(a2.h);
            if (b)
              return a2.h.m = false, { value: b.value, done: false };
          } catch (c2) {
      ...
      z2("Promise", function(a2) {
        ...
        b.prototype.v = function(f2, h2) {
          if (0 != this.i)
            throw Error("Cannot settle(" + f2 + ", " + h2 + "): Promise already settled in state" + this.i);
          this.i = f2;
          this.j = h2;
          2 === this.i && this.K();
          this.H();
        ...
        b.prototype.H = function() {
          if (null != this.h) {
            for (var f2 = 0; f2 < this.h.length; ++f2)
              g2.i(this.h[f2]);
            this.h = null;
          }
        };
        ...
        b.race = function(f2) {
          return new b(function(h2, k) {
            for (var l2 = A2(f2), m2 = l2.next(); !m2.done; m2 = l2.next())
              d2(m2.value).T(h2, k);
          });
        };
        b.all = function(f2) {
      ...
      function Aa(a2, b) {
        ...
        for (var d2; a2.length && (d2 = a2.shift()); )
          a2.length || void 0 === b ? c2[d2] && c2[d2] !== Object.prototype[d2] ? c2 = c2[d2] : c2 = c2[d2] = {} : c2[d2] = b;
      }
      ;
      function Ba(a2) {
        var b;
      ...
      var Ca = Array.prototype.map ? function(a2, b) {
        ...
        for (var c2 = a2.length, d2 = Array(c2), e = "string" === typeof a2 ? a2.split("") : a2, g2 = 0; g2 < c2; g2++)
          g2 in e && (d2[g2] = b.call(void 0, e[g2], g2, a2));
        return d2;
      };
      var Da = {}, Ea = null;
      function Fa(a2) {
      ...
      function Ka(a2) {
        ...
        for (b = ""; 10240 < a2.length; )
          b += String.fromCharCode.apply(null, a2.subarray(0, 10240)), a2 = a2.subarray(10240);
      ...
      function Wa(a2) {
        ...
        if (16 > a2.length)
          ...
          a2 = BigInt(a2), G2 = Number(a2 & BigInt(4294967295)) >>> 0, H = Number(a2 >> BigInt(32) & BigInt(4294967295));
        else {
          var b = +("-" === a2[0]);
          H = G2 = 0;
          for (var c2 = a2.length, d2 = b, e = (c2 - b) % 6 + b; e <= c2; d2 = e, e += 6)
            d2 = Number(a2.slice(d2, e)), H *= 1e6, G2 = 1e6 * G2 + d2, 4294967296 <= G2 && (H += G2 / 4294967296 | 0, G2 %= 4294967296);
      ...
      function lb(a2) {
        if ("string" === typeof a2)
          return { buffer: Na(a2), C: false };
        if (Array.isArray(a2))
          return { buffer: new Uint8Array(a2), C: false };
        if (a2.constructor === Uint8Array)
          return { buffer: a2, C: false };
        if (a2.constructor === ArrayBuffer)
          return { buffer: new Uint8Array(a2), C: false };
        if (a2.constructor === ib)
          return { buffer: kb(a2) || Pa(), C: true };
        if (a2 instanceof Uint8Array)
          return { buffer: new Uint8Array(a2.buffer, a2.byteOffset, a2.byteLength), C: false };
      ...
      function ob(a2) {
        ...
        if (d2 & 128 && (d2 = b[c2++], e |= (d2 & 127) << 7, d2 & 128 && (d2 = b[c2++], e |= (d2 & 127) << 14, d2 & 128 && (d2 = b[c2++], e |= (d2 & 127) << 21, d2 & 128 && (d2 = b[c2++], e |= d2 << 28, d2 & 128 && b[c2++] & 128 && b[c2++] & 128 && b[c2++] & 128 && b[c2++] & 128 && b[c2++] & 128)))))
          throw Za();
        L2(a2, c2);
        return e;
      }
      ...
      function sb(a2, b, c2) {
        for (; 0 < c2 || 127 < b; )
          a2.h.push(b & 127 | 128), b = (b >>> 7 | c2 << 25) >>> 0, c2 >>>= 7;
        a2.h.push(b);
      }
      function M(a2, b) {
        for (; 127 < b; )
          a2.h.push(b & 127 | 128), b >>>= 7;
        a2.h.push(b);
      }
      ;
      function tb(a2, b) {
      ...
      function ub(a2) {
        ...
        if (!(0 <= c2 && 5 >= c2))
          throw Ya(c2, a2.j);
        if (1 > b)
          throw Error("Invalid field number: " + b + " (at position " + a2.j + ")");
        a2.l = b;
        a2.i = c2;
        return true;
      }
        ...
        switch (a2.i) {
          case 0:
            if (0 != a2.i)
              ...
              a: {
                a2 = a2.h;
                for (var b = a2.h, c2 = b + 10, d2 = a2.i; b < c2; )
                  if (0 === (d2[b++] & 128)) {
                    L2(a2, b);
                    break a;
                  }
      ...
      function Lb(a2, b, c2, d2) {
        ...
        g2 & 1 || Ab(e);
        if (d2)
          g2 & 2 || P(e, 2), c2 & 1 || Object.freeze(e);
        else {
          d2 = !(c2 & 2);
          var f2 = g2 & 2;
      ...
      function V2(a2, b, c2) {
        if (null != c2 && "number" !== typeof c2)
          throw Error("Value of float/double field must be a number|null|undefined, found " + typeof c2 + ": " + c2);
        U(a2, b, c2);
      }
        ...
        switch (typeof a2) {
          ...
          case "object":
            if (a2)
              if (Array.isArray(a2)) {
                if (0 !== (Q2(a2) & 128))
                  return a2 = Array.prototype.slice.call(a2), Ib(a2), a2;
              } else {
                if (Ia && null != a2 && a2 instanceof Uint8Array)
                  return Ka(a2);
                if (a2 instanceof ib) {
                  var b = a2.V;
      ...
      function Ub(a2, b, c2, d2) {
        if (null != a2) {
          if (Array.isArray(a2))
            a2 = Vb(a2, b, c2, void 0 !== d2);
          else if (Eb(a2)) {
            var e = {}, g2;
            for (g2 in a2)
              e[g2] = Ub(a2[g2], b, c2, d2);
            a2 = e;
          } else
            a2 = b(a2, d2);
          return a2;
      ...
      function Yb(a2, b, c2) {
        c2 = void 0 === c2 ? Cb : c2;
        if (null != a2) {
          if (Ia && a2 instanceof Uint8Array)
            return a2.length ? new ib(new Uint8Array(a2), Qa) : jb();
          if (Array.isArray(a2)) {
            var d2 = Q2(a2);
            if (d2 & 2)
              return a2;
            if (b && !(d2 & 32) && (d2 & 16 || 0 === d2))
              return R2(a2, d2 | 2), a2;
      ...
      function Pb(a2, b) {
        ...
        g2 = !!(Q2(c2) & 16);
        for (var f2 = e ? c2.length - 1 : c2.length, h2 = 0; h2 < f2; h2++)
          $b(a2, d2, h2 - a2.G, c2[h2], false, g2, b);
        if (e)
          for (var k in e)
            $b(a2, d2, +k, e[k], true, g2, b);
        return d2;
      }
      ;
      function X2(a2, b, c2) {
        ...
        if (c2) {
          ...
          for (k = 0; k < c2.length; k++)
            f2 = c2[k], f2 < e ? (f2 += this.G, (d2 = a2[f2]) ? ac(d2, b) : a2[f2] = Fb) : (n || (n = Jb(this)), (d2 = n[f2]) ? ac(d2, b) : n[f2] = Fb);
        }
      }
      ...
      function oc(a2, b, c2, d2, e, g2) {
        ...
        for (; f2 < a2.length; ) {
          c2 = a2[f2++];
          for (var k = f2 + 1; k < a2.length && "number" !== typeof a2[k]; )
            k++;
          h2 = a2[f2++];
          k -= f2;
          switch (k) {
      ...
      function rc(a2, b, c2) {
        for (var d2 = c2.length, e = 1 == d2 % 2, g2 = e ? 1 : 0; g2 < d2; g2 += 2)
          (0, c2[g2 + 1])(b, a2, c2[g2]);
      ...
      var Y2 = Ac(function(a2, b, c2) {
        ...
        b = S(b, c2);
        if (null != b && null != b)
          if (M(a2.h, 8 * c2), a2 = a2.h, c2 = b, 0 <= c2)
            M(a2, c2);
          else {
            for (b = 0; 9 > b; b++)
              a2.h.push(c2 & 127 | 128), c2 >>= 7;
            a2.h.push(1);
          }
        ...
        if (db) {
          ...
          d2 = h2 + d2;
          e = [];
          for (var k = null, l2, m2; h2 < d2; )
            l2 = a2[h2++], 128 > l2 ? e.push(l2) : 224 > l2 ? h2 >= d2 ? K() : (m2 = a2[h2++], 194 > l2 || 128 !== (m2 & 192) ? (h2--, K()) : e.push((l2 & 31) << 6 | m2 & 63)) : 240 > l2 ? h2 >= d2 - 1 ? K() : (m2 = a2[h2++], 128 !== (m2 & 192) || 224 === l2 && 160 > m2 || 237 === l2 && 160 <= m2 || 128 !== ((g2 = a2[h2++]) & 192) ? (h2--, K()) : e.push((l2 & 15) << 12 | (m2 & 63) << 6 | g2 & 63)) : 244 >= l2 ? h2 >= d2 - 2 ? K() : (m2 = a2[h2++], 128 !== (m2 & 192) || 0 !== (l2 << 28) + (m2 - 144) >> 30 || 128 !== ((g2 = a2[h2++]) & 192) || 128 !== ((f2 = a2[h2++]) & 192) ? (h2--, K()) : (l2 = (l2 & 7) << 18 | (m2 & 63) << 12 | (g2 & 63) << 6 | f2 & 63, l2 -= 65536, e.push((l2 >> 10 & 1023) + 55296, (l2 & 1023) + 56320))) : K(), 8192 <= e.length && (k = ab(k, e), e.length = 0);
          h2 = ab(k, e);
        }
        U(b, c2, h2);
        return true;
        ...
        if (f2)
          throw Error("Message parsing ended unexpectedly. Expected to read " + (d2 + " bytes, instead read " + (d2 - f2) + " bytes, either the data ended unexpectedly or the message misreported its own length"));
        a2.h.h = g2;
        a2.h.j = c2;
        return true;
        ...
        if (null != b)
          for (d2 = 0; d2 < b.length; d2++) {
            ...
            f2 = a2;
            var h2 = g2.pop();
            for (h2 = f2.i + f2.h.length() - h2; 127 < h2; )
              g2.push(h2 & 127 | 128), h2 >>>= 7, f2.i++;
            g2.push(h2);
            f2.i++;
          }
      });
      ...
      function Xc(a2, b, c2) {
        Yc(a2, b);
        if ("function" === typeof a2.h.canvas.transferToImageBitmap)
          return Promise.resolve(a2.h.canvas.transferToImageBitmap());
        if (c2)
          return Promise.resolve(a2.h.canvas);
        if ("function" === typeof createImageBitmap)
          return createImageBitmap(a2.h.canvas);
        ...
        return E(function(p2) {
          switch (p2.h) {
            ...
            case 2:
              c2 = p2.i;
              if ("object" === typeof window)
                return bd("createMediapipeSolutionsWasm", { locateFile: a2.locateFile }), bd("createMediapipeSolutionsPackedAssets", { locateFile: a2.locateFile }), f2 = b.filter(function(n) {
                  ...
                  return E(function(w) {
                    if (1 == w.h)
                      return n = window.createMediapipeSolutionsWasm, q2 = window.createMediapipeSolutionsPackedAssets, t = a2, D2(w, n(q2), 2);
                    t.i = w.i;
                    w.h = 0;
                  });
                }), m2 = function() {
            ...
            case 7:
              ...
              if (!r2 && (r2 = a2.m.getContext("webgl", {}), !r2))
      ...
      function hd(a2) {
        ...
        return E(function(l2) {
          if (1 == l2.h) {
            if (a2.h.graph && a2.h.graph.url && a2.fa === a2.h.graph.url)
              return l2.return();
            a2.u = true;
          ...
          for (d2 = c2.next(); !d2.done; d2 = c2.next())
            e = d2.value, a2.j.overrideFile(e, a2.D[e]);
          a2.D = {};
          if (a2.h.listeners)
            for (g2 = A2(a2.h.listeners), f2 = g2.next(); !f2.done; f2 = g2.next())
              h2 = f2.value, id(a2, h2);
          k = a2.l;
          a2.l = {};
          a2.setOptions(k);
          l2.h = 0;
      ...
      x.setOptions = function(a2, b) {
        ...
        if (b = b || this.h.options) {
          for (var d2 = [], e = [], g2 = {}, f2 = A2(Object.keys(a2)), h2 = f2.next(); !h2.done; g2 = { X: g2.X, Y: g2.Y }, h2 = f2.next())
            if (h2 = h2.value, !(h2 in this.l && this.l[h2] === a2[h2])) {
              this.l[h2] = a2[h2];
              var k = b[h2];
          ...
          if (0 !== d2.length || 0 !== e.length)
            this.u = true, this.H = (void 0 === this.H ? [] : this.H).concat(e), this.F = (void 0 === this.F ? [] : this.F).concat(d2);
        }
      };
      function jd(a2) {
        ...
        return E(function(p2) {
          switch (p2.h) {
            ...
            case 3:
              ...
              for (f2 = g2.next(); !f2.done; f2 = g2.next())
                if (h2 = f2.value, k = c2.h.inputs[h2]) {
                  a: {
                    var n = a2[h2];
                    switch (k.type) {
                      case "video":
                      ...
                      case "detections":
                        ...
                        for (w = 0; w < n.length; ++w) {
                          ...
                          if (t.ba)
                            for (v2 = 0; v2 < t.ba.length; ++v2)
                              B2 = q2.data, J2 = B2.addClassification, I = w, u2 = t.ba[v2], C2 = new Z2(), V2(C2, 2, u2.qa), u2.index && U(C2, 1, u2.index), u2.label && U(C2, 3, u2.label), u2.displayName && U(C2, 4, u2.displayName), u2 = C2.l(), J2.call(B2, I, u2);
                        }
                        q2 = q2.data;
                        break a;
                      default:
        ...
        return E(function(v2) {
          switch (v2.h) {
            case 1:
              ...
              for (f2 = g2.next(); !f2.done; f2 = g2.next())
                h2 = f2.value, k = c2[h2], "string" !== typeof k && "texture" === k.type && void 0 !== b[k.stream] && ++e;
              1 < e && (a2.M = false);
            ...
            case 2:
              ...
              r2 = c2[m2];
              if ("string" === typeof r2)
                return t = d2, w = m2, D2(v2, ld(a2, m2, b[r2]), 14);
              p2 = b[r2.stream];
      ...
      function id(a2, b) {
        for (var c2 = b.name || "$", d2 = [].concat(ea(b.wants)), e = new a2.i.StringList(), g2 = A2(b.wants), f2 = g2.next(); !f2.done; f2 = g2.next())
          e.push_back(f2.value);
        g2 = a2.i.PacketListener.implement({ onResults: function(h2) {
          for (var k = {}, l2 = 0; l2 < b.wants.length; ++l2)
            k[d2[l2]] = h2.get(l2);
        ...
        this.h = new ed({ locateFile: a2.locateFile, files: function(c2) {
          ...
          onChange: function(c2) {
            ...
            return E(function(f2) {
              if (1 == f2.h)
                return d2 = md(c2), e = "third_party/mediapipe/modules/selfie_segmentation/" + d2, D2(f2, gd(b.h, d2), 2);
              g2 = f2.i;
...
var C = function() {
  return C = Object.assign || function(t) {
    for (var e, n = 1, r2 = arguments.length; n < r2; n++)
  ...
  function s2(o3) {
    return function(s3) {
      return function(o4) {
        ...
        for (; a2; )
          try {
            if (n = 1, r2 && (i2 = 2 & o4[0] ? r2.return : o4[0] ? r2.throw || ((i2 = r2.return) && i2.call(r2), 0) : r2.next) && !(i2 = i2.call(r2, o4[1])).done)
              return i2;
...
function it(t, e, n) {
  void 0 === n && (n = 0.3);
  for (var r2 = 0, i2 = 0, o2 = 0; o2 < t.length; o2++)
    e.keypoints[o2].score > n && (i2 += 1, r2 += Math.pow(t[o2].x - e.keypoints[o2].position.x, 2) + Math.pow(t[o2].y - e.keypoints[o2].position.y, 2));
...
function ut(t, e, n, r2, i2, o2, a2, s2, u2, f2, l2) {
  for (var d2 = a2[0], h2 = a2[1], p2 = t.shape, m2 = p2[0], g2 = p2[1], v2 = e.shape.slice(0, 2), w = v2[0], y = v2[1], x = reshape(e, [w, y, 2, $]), M = new Float32Array(l2 * $ * 3).fill(0), k = 0; k < n.length; k++)
      ...
      switch (S.label) {
        ...
        case 4:
          b = S.sent(), v2 = function(t2, e2, n2, r2, i2, o3, a2, s3, u3, f4) {
            ...
            }), h3 = s3.top, p3 = s3.left, m3 = Z([r2, i2], [l3, c3], s3), g3 = m3[0], v3 = m3[1], w2 = st([l3, c3], o3)[0], y2 = 0; y2 < r2; y2 += 1)
              for (var b2 = 0; b2 < i2; b2 += 1) {
                var S2 = y2 * i2 + b2;
                if (1 === t2[S2]) {
      ...
      switch (I.label) {
        ...
        case 5:
          P = I.sent(), S = function(t2, e2, n2, r2, i2, o3, a2, s3, u3, f3, l4) {
            ...
            }), p2 = u3.top, m3 = u3.left, g3 = Z([i2, o3], [c3, d2], u3), v3 = g3[0], w2 = g3[1], y2 = st([c3, d2], a2)[0], b2 = 0; b2 < i2; b2 += 1)
              for (var S2 = 0; S2 < o3; S2 += 1) {
                var x2 = b2 * o3 + S2;
                if (1 === t2[x2]) {
...
function pt(t, e, n, r2, i2, o2) {
  for (var a2 = o2.shape, s2 = a2[0], u2 = a2[1], f2 = true, l2 = Math.max(n - i2, 0), c2 = Math.min(n + i2 + 1, s2), d2 = l2; d2 < c2; ++d2) {
    for (var h2 = Math.max(r2 - i2, 0), p2 = Math.min(r2 + i2 + 1, u2), m2 = h2; m2 < p2; ++m2)
      if (o2.get(d2, m2, t) > e) {
        f2 = false;
        break;
      }
...
function qt(t) {
  ...
  if (r2 < 0 || r2 > 1)
    throw new Error("Invalid scoreThreshold " + r2 + ". Should be in range [0.0, 1.0]");
  if (i2 <= 0)
    throw new Error("Invalid nmsRadius " + i2 + ".");
}
function Nt(t) {
  ...
  if (i2 <= 0)
    throw new Error("Invalid nmsRadius " + i2 + ".");
  if (o2 < 0 || o2 > 1)
    throw new Error("Invalid minKeypointScore " + o2 + ".Should be in range [0.0, 1.0]");
  if (a2 <= 0 || a2 > 20)
    throw new Error("Invalid refineSteps " + a2 + ".Should be in range [1, 20]");
}
var Qt = function() {
  function t(t2) {
    this.baseModel = t2;
...
function Xt(e) {
  return D(this, void 0, void 0, function() {
    ...
    return B(this, function(u2) {
      switch (u2.label) {
        case 0:
          if (n = e.outputStride, r2 = e.quantBytes, i2 = e.multiplier, null == dist_exports)
...
function Yt(e) {
  return D(this, void 0, void 0, function() {
    ...
    return B(this, function(s2) {
      switch (s2.label) {
        case 0:
          if (n = e.outputStride, r2 = e.quantBytes, null == dist_exports)
            throw new Error("Cannot find TensorFlow.js. If you are using a <script> tag, please also include @tensorflow/tfjs on the page before using this\n        model.");
  ...
  function s2(i3) {
    return function(s3) {
      return function(i4) {
        ...
        for (; a2; )
          try {
            if (n = 1, r2 && (o2 = 2 & i4[0] ? r2.return : i4[0] ? r2.throw || ((o2 = r2.return) && o2.call(r2), 0) : r2.next) && !(o2 = o2.call(r2, i4[1])).done)
              return o2;
        ...
        switch (i2.label) {
          case 0:
            return o2 = function(t3) {
              if (null == t3 || null == t3.minDepth || null == t3.maxDepth)
                throw new Error("An estimation config with minDepth and maxDepth set must be provided.");
              if (t3.minDepth > t3.maxDepth)
